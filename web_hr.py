...
def get_db_connection():
    # هنا بنربط مع SQL Server
    conn_str = (
        'DRIVER={ODBC Driver 17 for SQL Server};'
        'SERVER=Your_Server_Name;' # استبدل Your_Server_Name باسم سيرفر زميلك
        'DATABASE=Your_Database_Name;' # استبدل Your_Database_Name باسم قاعدة البيانات
...
def dashboard():
    ...
    return render_template('dashboard.html', admin_name=session['user_name'], total=total, present=present, absent=absent)
